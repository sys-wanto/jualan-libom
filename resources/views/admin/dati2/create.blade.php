        ...
        <form class="w-full" action="{{ route('admin.dati2.store') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <select name="kd_propinsi" id="kd_propinsi"
              ...
              <!-- <input value="{{ old('kd_propinsi') }}" name="kd_propinsi" maxlength="2"
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <input value="{{ old('kd_propinsi') }}" name="kd_dati2" maxlength="2"
                     class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                     id="grid-last-name" type="text" placeholder="Kode {{$title}}" required>
              <div class="mt-2 text-sm text-gray-500">
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <input value="{{ old('nm_propinsi') }}" name="nm_dati2"
                     class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
